...
page = do
  ...
  div_ [id_ "parent"] $
    div_ [id_ "top"] $
      div_ [class_ "mlr"] $ do
        div_ [class_ "mleft", style_ "margin-top: 50px;"] "404"
        div_ [class_ "mright", style_ "padding-top: 250px;"] $ do
          h3_ "Hello {{name}}!"
          "Name:"
